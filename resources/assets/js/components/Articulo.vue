    ...
    export default {
        ...
        methods : {
            ...
            validarArticulo(){
                ...
                if(!this.nombre) this.errorMostrarMsjArticulo.push('El nombre no puede ir vacio');
                // if(!this.stock) this.errorMostrarMsjArticulo.push('El stock no puede ir vacio y debe ser un número');
                if(!this.precio_venta) this.errorMostrarMsjArticulo.push('El precio de venta no puede ir vacio y debe ser un número');
