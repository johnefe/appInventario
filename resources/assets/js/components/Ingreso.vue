                            ...
                            <div class="table-responsive">
                                ...
                                <tbody>
                                    <tr v-for="ingreso in arrayIngreso" :key="ingreso.id">
                                        ...
                                        <td class="text-center" v-text="ingreso.num_comprobante"></td>
                    ...
                    <template v-else-if="listado==0">
                        <div class="card-body">
                            <div class="form-group row border">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label><strong>Numero Comprobante(*)</strong></label>
                            ...
                            <div class="form-group row border">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label><strong>Precio</strong> <span style="color:red" v-show="precio== 0">(*Ingrese)</span></label>
                                        <input type="number" value="0" step="any" class="form-control" v-model="precio" >
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label><strong>Cantidad</strong><span style="color:red" v-show="cantidad == 0">(*Ingrese)</span></label>
                                ...
                                <div class="table-responsive col-md-12">
                                    <table class="table table-bordered table-striped table-sm">
                                        ...
                                        <tbody v-if="arrayDetalle.length">
                                            ...
                                            <td><input v-model="detalle.cantidad" type="number" value="2" class="form-control"></td>
    ...
    export default {
        ...
        methods : {
            onChange(event){
                ...
                var url = '/ingreso/BuscarUltimoIngreso?valor='+valor;

                /******************** */
                 axios.get(url).then(function (response){
                    var numero = 0;
                    let respuesta = response.data;
                    me.arrayIngreso= respuesta.ingreso;
                    console.log(me.arrayIngreso);

                    if (me.arrayIngreso.length>0) {
                        numero = parseInt(me.arrayIngreso[0]['num_comprobante']) + 1;

                    } else {
                        numero = 1;
                    }
                    //let numero = parseInt(me.arrayIngreso[0]['num_comprobante']) + 1;
            ...
            cargarPdf(){
                window.open('http://localhost:8000/ingreso/listarPdf','_blank');
            },
            ...
            validarIngreso(){
                ...
                if(this.arrayDetalle.length<=0) this.errorMostrarMsjIngreso.push('Ingrese algún detalle');
                ...
                swal({
                            ...
                            text: this.errorMostrarMsjIngreso,
                        })
                this.errorIngreso = 1;
                }
