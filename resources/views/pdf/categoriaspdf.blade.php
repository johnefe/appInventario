        ...
        <div class="row">
            <div class="">
                <div class="col-lg-12 text-center">
                    <h3 style="color:red;">Lista de categorias </h3>
                ...
                <div>
                    <table class="table table table-sm table-active table-bordered table-striped table-sm">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{$a->nombre}}</td>
                                <td>{{$a->descripcion}}</td>
                                <td>{{$a->condicion?'Activa':'Desactivada'}}</td>
                            </tr>
                            @endforeach
                        </tbody>
                    </table>
